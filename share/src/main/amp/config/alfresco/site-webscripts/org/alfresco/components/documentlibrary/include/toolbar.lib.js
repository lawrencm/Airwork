...
//this function has been overridden toa llow for toolbar actions
...
//Custom definition of actionSet
      ...
      if (toolbarActions)
      {
          ...
          {  
             ...
             actionSet.push(
             {
                ...
                hasAspect: (xmlAction["hasAspect"] !== null)?xmlAction["hasAspect"].toString() : "",
                notAspect: (xmlAction["notAspect"] !== null)?xmlAction["notAspect"].toString() : ""
             });
          }
